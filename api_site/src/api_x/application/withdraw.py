...
def apply_to_withdraw(from_user_id, bankcard, amount, fee, client_notify_url, data):
    # FIXME:
    # 在application成为真正独立子系统时，这里应该使用api交互
    from api_x.zyt.biz import withdraw
    withdraw_record = withdraw.apply_to_withdraw(from_user_id, bankcard.flag_card, bankcard.card_type, bankcard.card_no,
