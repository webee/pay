...
withdraw_config = AttrDict(
    api_version="1.2",

    withdraw=AttrDict(
        cardandpay_url="https://yintong.com.cn/traderapi/cardandpay.htm",
        orderquery_url="https://yintong.com.cn/traderapi/orderquery.htm",
...
config = withdraw_config.merge_to(lianlian_base_config)
